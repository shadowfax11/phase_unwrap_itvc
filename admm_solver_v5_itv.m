function [u1,u2,costs] = admm_solver_v5_itv(g1,g2,h1,h2,h3,h4,hyperparam_lst)
...
F_g12 = create_grad_operator(s_g1, s_g2, n_g1, n_g2);
...
F_g12 = [F_g12; beta_1*create_irr_operator(s_g1, s_g2, n_g1, n_g2)]; 
F_h12 = [F_h12; beta_2*create_irr_operator(s_h1, s_h2, n_h1, n_h2)];
F_h34 = [F_h34; beta_2*create_irr_operator(s_h3, s_h4, n_h3, n_h4)];
